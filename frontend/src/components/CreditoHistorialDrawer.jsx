...
const CreditoHistorialDrawer = ({ creditoId, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      {/* Drawer derecho */}
      <div
        className={`absolute right-0 top-0 bottom-0 w-full md:w-96 bg-white shadow-xl p-4 overflow-auto transform-gpu will-change-transform transition-transform duration-300 ease-out ${entered ? "translate-x-0" : "translate-x-full"}`}
      >
