  ...
  const getDocumentoInfo = (mov) => {
    ...
    if (mov.tipo_origen_movimiento === "produccion") {
      ...
      return mov.referencia_documento_id
        ? `Lote #${mov.referencia_documento_id}`
        : null;
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFilterChange(setMesSeleccionado)(e.target.value)
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFilterChange(setAnioSeleccionado)(e.target.value)
              }
              className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 cursor-pointer"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleFilterChange(setTipoSeleccionado)(e.target.value)
              }
              className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 cursor-pointer"
            >
              ...
              <thead className="bg-slate-100 text-slate-700">
                <tr>
                  ...
                  <th
                    ...
                    title="Venta: Cliente final | Compra: Proveedor | Fabricación: Cliente del pedido"
                  >
                    Entidad
                  </th>
                      ...
                      <td className="px-4 py-3">
                        {entidadInfo.aplica ? (
                          <div
                            ...
                            title={entidadInfo.tooltip}
                          >
                            <FiUser size={14} className="text-slate-400" />
                            <div>
                              <span className="text-slate-700 truncate max-w-[150px] block">
                                {entidadInfo.valor}
                              </span>
                              {entidadInfo.tooltip && (
          ...
          <div className="px-4 py-4 border-t border-slate-200 bg-slate-50">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-slate-600">
                ...
                de <span className="font-semibold">{total}</span> movimientos
              </div>
              <div className="flex items-center gap-2">
                <button
                  disabled={page <= 1}
